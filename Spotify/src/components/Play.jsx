...
const Play = () => {
	const { seekBar, seekBg, playStatus, play,seekSong, pause, track, time,previous,next } = useContext(PlayerContext);
	return (
		<div className='h-[10%] flex bg-black justify-between items-center text-white px-4'>
			...
			<div className='flex flex-col items-center gap-1 m-auto'>
				<div className='flex gap-4'>
					...
					{playStatus ? <img onClick={pause} src={assets.pause_icon} alt="" className='cursor-pointer w-4' /> : <img onClick={play} src={assets.play_icon} alt="" className='cursor-pointer w-4' />}
