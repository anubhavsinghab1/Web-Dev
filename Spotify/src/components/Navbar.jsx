  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <p className='text-black bg-purple-500 w-7 h-7 rounded-full items-center justify-center flex'>A</p>
        </div>
    </div>
    <div className='flex items-center gap-2 mt-4'>
      ...
      <p className='cursor-pointer bg-black px-4 py-1 rounded-2xl'>Poscasts</p>
    </div>
    </>
  )
}
